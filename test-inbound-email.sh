...
if [ "$TOTAL_MSGS" -gt 0 ]; then
    ...
    echo ""
    echo "   Try sending a test email from Gmail/Outlook to: test@$MAIL_DOMAIN"
    echo ""
    ...
    echo "   1. User doesn't exist (create one first)"
